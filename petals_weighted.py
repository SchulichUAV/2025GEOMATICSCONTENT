...
def parametric_model(file_path):
    ...
    def parse_json_to_vectors(file_path):
        ...
        keys = ["image", "x", "y", "lat", "lon", "rel_alt", "alt", "roll", "pitch", "yaw", "position_uncertainty"]
    ...
    def parametric_adjustment(easting_drone, northing_drone, agl_drone, easting_target, northing_target, obs_std):
        ...
        # Compute weight matrix P, rescaled to perform data snooping
        P = np.linalg.inv(Cl) / a_posteriori_variance_factor
