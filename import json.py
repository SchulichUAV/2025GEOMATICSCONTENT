# script to convert a folder containing multiple json files to a single txt named odm_geotags.txt
# to test, take some jsons and its corresponding capture and put in a folder, then change the directory
